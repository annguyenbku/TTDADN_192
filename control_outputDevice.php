...
<head>
    ...
    body {
        background-image: url('https://www.androidguys.com/wp-content/uploads/2016/09/iStock_000034930054_Lightbulb.jpg');
        height: 100%;
...
<body>
        ...
        <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
            <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
                ...
                <li class="nav-item active">
                    <a class="nav-link" href="control_outputDevice.php"><i class="fa fa-home"></i>Điều khiển đèn</a>
                </li>
    ...
    <div id="addQuestion">
        ...
        <form method="POST">
            <p size="100"><label style="color:#FFFFFF" >Status: </label> <p style="color:#FFFFFF"><label class="radio-inline"><input type="radio" name="optradio" value='1' checked> On </label></p>
            <p style="color:#FFFFFF"><label class="radio-inline"><input type="radio" name="optradio" value='0'> Off</label></p>
            </p>
            
            <p  style="color:#FFFFFF"><label for="range_weight">Magnitude of the light: </label> <input type="range" name="magnitude" class="slider" min="0" max="255" value="0">
